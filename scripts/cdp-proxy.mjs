    ...
    if (ok) {
      ...
      try {
        ...
        if (info?.webSocketDebuggerUrl) {
          ...
          console.log(`[CDP Proxy] 从 /json/version 获取 wsPath: ${wsPath}`);
          return { port, wsPath };
        }
      } catch { /* 忽略，继续 */ }
...
function sendCDP(method, params = {}, sessionId = null) {
  return new Promise((resolve, reject) => {
    ...
    const timeoutMs = method === 'Runtime.evaluate' ? 300000 : 30000;
